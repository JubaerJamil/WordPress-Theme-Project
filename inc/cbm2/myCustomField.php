...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'object_types'  => array( 'pricing', 'page' ), // Post type
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Duration', 'textdomain' ),
		'desc' => esc_html__( '', 'textdomain' ),
		'id'   => 'pricing_duration',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Icon class', 'textdomain' ),
		'desc' => esc_html__( 'add icon class', 'textdomain' ),
		'id'   => 'pricing_icon',
		'type' => 'text_medium',
	) );
...
function yourprefix_register_repeatable_group_field_metabox() {
	...
	$cmb_group = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Repeating Field Group', 'textdomain' ),
	...
	$group_field_id = $cmb_group->add_field( array(
		...
		'type'        => 'group',
		// 'description' => esc_html__( 'Generates reusable form entries', 'textdomain' ),
		'options'     => array(
			'group_title'    => esc_html__( 'Entry {#}', 'textdomain' ), // {#} gets replaced by row number
			'add_button'     => esc_html__( 'Add Another Item', 'textdomain' ),
			'remove_button'  => esc_html__( 'Remove Entry', 'textdomain' ),
			'sortable'       => true,
		),
	) );
	...
	$cmb_group->add_group_field( $group_field_id, array(
		'name'       => esc_html__( 'Icon', 'textdomain' ),
		'id'         => 'title',
		'type'       => 'text',
	) );
	...
	$cmb_group->add_group_field( $group_field_id, array(
		...
		'description' => esc_html__( 'Write a short description for this pricing', 'textdomain' ),
		'id'          => 'description',
		'type'        => 'text',
	) );
